  ...
  return(
    <div className='instructions row'>
      ...
      <h4 className="instruction-list col-12">
        ...
        Each question answered incorrectly will continue to show up more frequently, 
        and each correct answer will show up less to help you master data structures and algorithms.
        Since you are logged in your progress will be automatically saved.
        You can reset you progress and start back at the beginning by clicking the Reset button.<br/>
